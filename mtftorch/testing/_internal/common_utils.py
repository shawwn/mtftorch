...
# import torch.cuda
# from mtftorch._utils_internal import get_writable_path
from mtftorch._six import string_classes
# import torch.backends.cudnn
# import torch.backends.mkl
from enum import Enum

# torch.backends.disable_global_flags() # TODO
...
def cppProfilingFlagsToProfilingMode():
    import warnings
    warnings.warn("cppProfilingFlagsToProfilingMode TODO")
    return
...
TEST_MKL = False #torch.backends.mkl.is_available() # TODO
...
class TestCase(expecttest.TestCase):
    ...
    dtype_precisions = {
        ...
        # torch.complex32  : (0.001, 1e-5), # TODO
